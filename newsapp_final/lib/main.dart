...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getNews({
    ...
    if (channel != null) {
      ...
      catagory = null;
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=eb54707000a943ff9e05f120c83fd206";
    }
    if (searchKey != null) {
      country = null;
      catagory = null;
      baseApi =
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apiKey=eb54707000a943ff9e05f120c83fd206";
    }
    //print(baseApi);
